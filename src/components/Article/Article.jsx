const Article = ({ title, text, tags, image, alt }) => {
    return (
        <div className="p-5 bg-gray-200 dark:bg-graySystem-200 sm:rounded-xl sm:shadow-lg flex flex-col items-center gap-2">
            ...
            <div className="w-full flex-row justify-end gap-2 pr-5 hidden sm:flex">
                {tags.map(tag => <span key={tag} className="bg-blueSystem-100 dark:bg-graySystem-100 px-4 py-1 rounded-full text-gray-200 font-bold text-xs uppercase">{tag}</span>)}
            </div>
