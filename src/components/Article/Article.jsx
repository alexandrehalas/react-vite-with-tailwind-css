const Article = ({ title, text, tags, image, alt }) => {
    return (
        <div className="p-5 bg-gray-200 dark:bg-graySystem-200 sm:rounded-xl sm:shadow-lg flex flex-col items-center">
            ...
            {image && <img className="mt-4" src='LoremIpsumDolor.png' />}
